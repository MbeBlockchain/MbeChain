...
MBE encourages developers to provide more decentralized cross-chain solution.  
...
- Do not misread the official website (mbecoin.com), and be cautious with private key phishing.
